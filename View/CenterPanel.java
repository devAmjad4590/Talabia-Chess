...
/**
 * The {@code CenterPanel} class represents a Swing JPanel that serves as the
 * central component
 * for displaying a chessboard in a graphical user interface.
 * It contains a 7x6 grid of TileGUI instances, each representing a visual tile
 * on the chessboard.
...
public class CenterPanel extends JPanel {
    ...
    /**
     * A 2D array of TileGUI instances representing the visual representation of
     * tiles on the chessboard.
     * Each element in the array corresponds to a specific position on the
     * chessboard.
     */
     ...
     * Populates the panel with TileGUI instances, each representing a visual tile
     * on the chessboard.
     */
    public CenterPanel() {
    ...
    /**
     * Reverses and adds row labels (numbers) to the WEST position and column labels
     * (letters) to the NORTH position.
     */
    ...
    /**
     * Sets an ActionListener for all tiles on the game board.
     * 
    ...
    /**
     * Clears the images of all tiles on the game board.
     */
